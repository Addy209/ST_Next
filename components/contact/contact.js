...
import { Stack, Input, HStack, VStack, Button, Box, Heading, Text,useMediaQuery,InputGroup,InputLeftElement } from "@chakra-ui/react"
...
const Contact=()=>{
    ...
    const data=(<>
                    ...
                    <InputGroup>
                        ...
                        />
                        <Input type="text" onChange={(event)=>handleFormFill(event,0)} value={contactform.name} placeholder="Name" />
                    </InputGroup>
                    ...
                    <InputGroup>
                        ...
                        />
                        <Input type="email" onChange={(event)=>handleFormFill(event,1)} value={contactform.email} placeholder="E-mail" />
                    </InputGroup>
                    <Button
                    p={4}
                    color="white"
    ...
    return(
         <div id='4' className="margin_div">
            ...
            <VStack style={{marginTop:'2%'}} spacing={2}>
                 <Box w='100%' h='50vh'>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2781.056485195517!2d77.38213570568148!3d28.572414027665207!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2265bdf0ca602547!2sFUTEC%20GATEWAY%20SECTOR%2075!5e0!3m2!1sen!2sin!4v1619292068307!5m2!1sen!2sin" width="100%" height="100%" allowFullScreen="" loading="lazy"></iframe>
                </Box>
